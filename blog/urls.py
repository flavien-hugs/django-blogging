...
from blog.views import (
    SearchView, IndexView, ListTag,
    ListByTag, post_detail, post_share,
...
urlpatterns = [
    ...
    path('categorie/', ListTag.as_view(), name='list_tag'),
    path('categorie/<slug:slug>/', ListByTag.as_view(), name='list_by_tag'),
    path('<slug:post>/<int:year>/<int:month>/<int:day>/', post_detail, name='post_detail'),
